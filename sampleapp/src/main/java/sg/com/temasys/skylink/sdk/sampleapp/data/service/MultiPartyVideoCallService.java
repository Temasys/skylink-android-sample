...
public class MultiPartyVideoCallService extends SDKService implements MultiPartyVideoCallContract.Service, LifeCycleListener, OsListener, MediaListener, RemotePeerListener, RecordingListener,
        StatsListener {

    private final String TAG = MultiPartyVideoCallService.class.getName();
    ...
    public MultiPartyVideoCallService(Context mContext) {
    ...
    //----------------------------------------------------------------------------------------------
    // MultiPartyVideoCallService implementation to work with SDK
    //----------------------------------------------------------------------------------------------

    public void connectToRoomServiceHandler(String roomName) {
        sdkConnectionManager = new SdkConnectionManager(mContext);
        skylinkConnection = sdkConnectionManager.initializeSkylinkConnectionForMultiPartyVideoCall();
