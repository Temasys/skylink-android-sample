...
public class DataTransferService{
    ...
    private static MultiPeersInfo dataRemotePeers;
...
//        skylinkConnection = sdkConnectionManager.initializeSkylinkConnection(Constants.CONFIG_TYPE.DATA);
//
//        setListeners();
//
...
//
//        boolean isPeerJoined = dataRemotePeers == null ? false : dataRemotePeers.isPeerJoined();
//
...
//        if (dataRemotePeers == null) {
//            dataRemotePeers = new MultiPeersInfo();
//            dataRemotePeers.setPeerJoined(true);
//
//            List<String> peerIdList = new ArrayList<String>();
//            peerIdList.add(remotePeerId);
//
//            dataRemotePeers.setPeerIdList(peerIdList);
//        } else {
//            dataRemotePeers.getPeerIdList().add(remotePeerId);
//        }
//
...
//        //reset dataRemotePeers if there are no more peers.
//        if (dataRemotePeers.getPeerIdList().size() == 1) {
//            dataRemotePeers = null;
//        } else {
//            dataRemotePeers.getPeerIdList().remove(remotePeerId);
//        }
//
