...
public class ChatService  {
    ...
    private static MultiPeersInfo chatRemotePeers;
...
//
//        skylinkConnection = sdkConnectionManager.initializeSkylinkConnection(Constants.CONFIG_TYPE.CHAT);
//
//        setListeners();
//
...
//
//        boolean isPeerJoined = chatRemotePeers == null ? false : chatRemotePeers.isPeerJoined();
//
...
//
//            //update UI
//            mPresenter.setRoomDetailsPresenterHandler();
//        }
//    }
//
//    @Override
...
//        if(chatRemotePeers == null){
//            chatRemotePeers = new MultiPeersInfo();
//            chatRemotePeers.setPeerJoined(true);
//
//            List<String> peerIdList = new ArrayList<String>();
//            peerIdList.add(remotePeerId);
//
//            chatRemotePeers.setPeerIdList(peerIdList);
//        } else{
//            chatRemotePeers.getPeerIdList().add(remotePeerId);
//        }
//
//        mPresenter.onRemotePeerJoinPresenterHandler(remotePeerId, nick);
//
...
//
//        //reset chatRemotePeers if there are no more peers.
//        if(chatRemotePeers.getPeerIdList().size() == 1){
//            chatRemotePeers = null;
//        } else{
//            chatRemotePeers.getPeerIdList().remove(remotePeerId);
//        }
//
...
//
//            mPresenter.onMessageReceivePresenterHandler(remotePeerName + " : " + chatPrefix + message);
//
//        }
//    }
//
