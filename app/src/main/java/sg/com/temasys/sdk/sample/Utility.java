...
public class Utility {
    ...
    final static public int REQUEST_CODE_PICK_DIR = 1;
    ...
    // it is not essential to show every single toast, like showing progress of file transfer.
    public static void showRapidShortToast(Context context, int messageId,
                                           String... args) {
        if (toastRapid != null) toastRapid.cancel();
        toastRapid = Toast.makeText(
                context, String.format(context.getString(messageId), (Object[]) args),
                Toast.LENGTH_SHORT);
        toastRapid.show();
    }
