...
public class JoinRoomActivity extends Activity {
    ...
    final static public String EXTRA_RESULT_DISCONNECT_STATUS = "sg.com.temasys.skylink.sdk.sample.JoinRoomActivity.disconnnectStatus";

    public enum DisconnectStatus {
        ON_CONNECT_FALSE(1), ON_DISCONNECT(2);
