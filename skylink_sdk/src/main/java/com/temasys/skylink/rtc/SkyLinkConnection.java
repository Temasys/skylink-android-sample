...
public class SkyLinkConnection {
     ...
     *
     * @param fileTransferDelegate The file transfer delegate object
     */
     ...
     *
     * @param lifeCycleDelegate The life cycle delegate object
     */
     ...
     *
     * @param mediaDelegate The media delegate object
     */
     ...
     *
     * @param messagesDelegate The messages delegate object
     */
     ...
     *
     * @param remotePeerDelegate The remote peer delegate object
     */
     ...
     * @param parentActivity The activity to which this connection object belongs
     */
    public SkyLinkConnection(String apiKey, String secret,
        ...
        if (this.myConfig.hasPeerMessaging() || this.myConfig.hasFileTransfer()) {
            this.dataChannelManager = new DataChannelManager(this,
                    this.myConfig.getTimeout(), myConfig.hasPeerMessaging(), myConfig.hasFileTransfer());
    ...
    private boolean isMCUPeer(String peerId) {
        return this.pcObserverPool.get(peerId).isMCU();
    }

    private void setMCUPeer(String peerId) {
        this.pcObserverPool.get(peerId).setMCU(true);
    }
            ...
            if (value.compareTo("inRoom") == 0) {
                ...
                if (connectionManager.dataChannelManager != null) {
                    ...
                    connectionManager.dataChannelManager
                            .setDisplayName(((JSONObject) connectionManager.myUserData)
                ...
                boolean isMCU = false;
                try {
                    isMCU = !objects.getBoolean("enableIceTrickle");
                } catch (JSONException e) {
                }
                double weight = 0.0;
                try {
    ...
    private class PCObserver implements PeerConnection.Observer {
        ...
        public void setMCU(boolean isMCU) {
            this.isMCU = isMCU;
        }
